...
/*   Updated: 2022/11/21 02:53:31 by oaboulgh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	node_creat(t_list **buffer, char *buff, int red)
{
	int		i;
	t_list	*last;
	t_list	*new;
...
static void	read_file(int fd, t_list **head)
{
	char	*buffer;
	int		read_count;
...
static void	get_line(t_list *head, char **line)
{
	int		i;
	int		j;
...
static void	rest_node(t_list **head)
{
	t_list	*node;
	t_list	*rest;
	int		j;
